        ...
        <CardContent className="p-0">
           ...
           <div className="bg-slate-900 text-white p-12 flex flex-col md:flex-row justify-between items-start gap-8 print:bg-white print:text-slate-900 print:border-b print:p-8">
              <div className="space-y-4">
                 ...
                 <p className="text-slate-400 font-medium max-w-xs print:text-slate-500">Curating the largest startup ecosystem in Bangladesh.</p>
              </div>
           ...
           <div className="p-12 space-y-16 print:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                 <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                       <p className="text-lg font-black text-slate-900">{user?.displayName || 'Service Provider'}</p>
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                       ...
                       <p className="text-sm font-medium text-slate-500">Client Partner</p>
              ...
              <div className="space-y-6">
                 <div className="flex items-center justify-between px-4 pb-4 border-b-2 border-slate-900/5">
                    <h3 className="text-[11px] font-black uppercase tracking-widest text-slate-400">Description</h3>
                    <h3 className="text-[11px] font-black uppercase tracking-widest text-slate-400">Total</h3>
                 </div>
                 <div className="px-4 py-8 rounded-[2rem] bg-slate-50 ring-1 ring-slate-100 flex items-center justify-between">
                    <div className="space-y-2">
                       <p className="text-2xl font-black text-slate-900">{invoice.title}</p>
                       <p className="text-sm font-medium text-slate-500 italic max-w-lg leading-relaxed">
                          {invoice.description || 'No detailed service description provided.'}
                       </p>
                    </div>
                    <div className="text-right">
                       <p className="text-4xl font-black text-slate-900">{formattedAmount}</p>
                    </div>
                 </div>
              </div>
              ...
              <div className="pt-16 border-t border-slate-50 space-y-4">
                 <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Notes & Instructions</p>
                 <p className="text-xs text-slate-500 leading-relaxed font-medium">
                    Please include the invoice number in your bank transfer reference. 
                    All payments are subject to our terms of service. Thank you for your partnership in building the ecosystem.
                 </p>
              </div>
           </div>
        </CardContent>
