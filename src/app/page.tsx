  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 flex flex-col gap-20 pb-20">
        <section className="relative overflow-hidden pt-20 md:pt-32">
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              ...
              A platform for the next generation of global entrepreneurs.
            </p>
        ...
        <section className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card key={i} className="hover:shadow-lg transition-shadow border-none shadow-sm rounded-2xl">
                <CardHeader>
        ...
        <section className="container mx-auto px-4">
          <div className="bg-primary text-primary-foreground rounded-[3rem] p-12 md:p-20 text-center shadow-xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Ready to grow your startup?</h2>
            ...
            <Button size="lg" variant="secondary" asChild className="px-10 rounded-full h-14 text-lg">
